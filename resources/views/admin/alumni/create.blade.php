    ...
    <div class="card p-4">
          ...
          <form action="{{ url('admin/alumni') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-2">
                ...
                <input required name="alamat" value="{{ old('alamat')}}" type="text" class="form-control @error('alamat') is-invalid @enderror" id="exampleInputEmail1" aria-describedby="emailHelp">
                @error('alamat')
                  <div class="invalid-feedback">
                      {{ $message}}
                  </div>
            ...
            <div class="mb-2">
              ...
              <div class="mb-2">
                ...
                <input required name="kontak" value="{{ old('kontak')}}" type="number" class="form-control @error('kontak') is-invalid @enderror" id="exampleInputEmail1" aria-describedby="emailHelp">
                @error('kontak')
                  <div class="invalid-feedback">
                      {{ $message}}
                  </div>
