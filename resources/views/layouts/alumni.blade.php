...
<html lang="en">
    ...
    <head>
        ...
        <!-- App Css-->
        <link href="{{ ('assets/alumni/css/app.min.css') }}" id="app-style" rel="stylesheet" type="text/css" />
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            ...
                            <a href="index.html" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="{{ url('assets/alumni/images/logo-light.png') }}" alt="" height="22">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{ url('assets/alumni/images/logo-light.png') }}" alt="" height="30">
                                </span>
                            </a>
                        </div>
